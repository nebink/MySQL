...
/* Deleting all the values inside the table persons using truncate

truncate is much faster than delete  because it skips so many process 
like updating logs and others protocol stuff which DELETE function dooes */
